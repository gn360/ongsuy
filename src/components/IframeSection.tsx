...
export default function IframeSection({
  ...
  return (
    <section className="py-12 px-4 rounded-[20px] md:rounded-none bg-white md:bg-transparent">
      ...
      <a href={dflink} target="_blank" style={{ display: 'none !important' }} rel="noopener noreferrer" className="block mt-4 text-center text-sm text-primary-400 hover:underline border border-primary-300 rounded-lg py-2 px-4 mx-auto max-w-xs">
